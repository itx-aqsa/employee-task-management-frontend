        ...
        <div className="min-h-screen bg-slate-50 flex">
            ...
            <aside className="w-64 bg-white border-r border-slate-100 flex flex-col fixed h-full">
                ...
                <nav className="flex-1 p-4 space-y-1">
                    ...
                    <Link href="/dashboard/admin/tasks/create" className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-indigo-50 text-indigo-700 font-medium text-sm">
            ...
            <main className="flex-1 ml-64 p-8">
                <div className="mb-8">
                    ...
                    <p className="text-slate-500 mt-1">Assign a new task to an employee</p>
                </div>
